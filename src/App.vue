<template>
    ...
    <div>
        ...
        <ul>
            <li class="w3-bar" v-for="tour in tours" :key="tour.id">
                <span onclick="this.parentElement.style.display='none'" class="w3-bar-item w3-button w3-xlarge w3-right">&times;</span>
                <img src="https://blog.pergi.com/wp-content/uploads/2018/12/Wisata-Populer-Tana-Toraja-Sumber-Instagram-lapangantigatiga-min.jpg" class="w3-bar-item w3-circle" style="width:85px; height: 85px;">
                <div class="w3-bar-item">
                    <span class="w3-large">{{ tour.title }}</span><br>
